...
export default function ListView(props) {
  ...
  return (
    <Box>
      <Box m="2" display="inline-block" boxShadow="0px 6px 10px rgba(0, 0, 0, 0.25);" p="4" rounded="xl">
        <Flex alignItems="center">
          <Flex fontSize="20px" fontWeight="600" alignItems="center" w="220px">
            ...
            <Box fontSize="sm" color="teal.400" backgroundColor="teal.50" px="2" mr="2" rounded={"full"} maxW="80px">
              {meta.industry}
            </Box>
          </Flex>
